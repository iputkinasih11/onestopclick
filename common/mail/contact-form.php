                ...
                <table id="center-cont" align="center" cellpadding="0" cellspacing="0" border="0" width="640" style="width: 640px; max-width: 640px;border-collapse: collapse;margin-top:0px; padding:0px; ">
                    ...
                    <tr>
                    	<td class="content"  bgcolor="#fff" style="padding:10px 20px 20px 20px;font-size: 16px;line-height: 160%; background:#fff; color:#333;">
                        	<div>
							    <p style="margin:15px 0;">You have a new inquiry from <?php echo $name;?></p>
							    <table cellpadding="0" cellspacing="0" style="width:580px;" width="580">
                                    <tr>
                                        <td style="vertical-align:top;width:150px;padding-bottom:10px;padding-left:10px;">Email</td>
                                        <td style="vertical-align:top;padding-bottom:10px;">:</td>
                                        <td style="vertical-align:top;padding-bottom:10px;padding-left:10px;"><?php echo $email;?></td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align:top;width:150px;padding-bottom:10px;padding-left:10px;">Message</td>
                                        <td style="vertical-align:top;padding-bottom:10px;">:</td>
                                        <td style="vertical-align:top;padding-bottom:10px;padding-left:10px;"><?php echo $message;?></td>
                                    </tr>    
                                </table>
							</div>
                        </td>
