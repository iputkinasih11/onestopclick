...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2018 at 11:24 AM
...
(2, 'Sub Category', 'sub-category', 1, '2018-06-22 01:41:44', '2018-06-22 01:41:44'),
...
(2, 'Admin', 'User can only create, update, and view but can not delete', 1);
...
(1, 'PAY2206180001', '2018-06-22 09:11:41', '0.00', '0.00', 0, '0.00', '0.00', '0.00', 0, '2018-06-22 09:11:41', '2018-06-22 09:11:41');
...
ALTER TABLE `payment_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payments_payment_detail` (`payment_id`);
...
--
ALTER TABLE `payment_detail`
  ADD CONSTRAINT `fk_payments_payment_detail` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`id`);
