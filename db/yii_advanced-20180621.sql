...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2018 at 11:05 AM
...
(7, 'iputkinasih@gmail.com', 'iput', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, '2018-06-21 15:25:48'),
(8, 'a@gmail.com', 'test', '96e79218965eb72c92a549dd5a330112', 1, 1, '2018-06-21 16:40:57');
...
(1, 'Super Admin', 'Super admin which can change your secret color in one click', 1),
(2, 'Admin', 'Normal admin which can update and create, but not delete stuff', 1);
...
(4, 'iput', 'Lucia', 'Kinasih', '123123', 'R4tXXvcvOXmBfasTyLqHr6VJ8NS_QGup', '$2y$13$YKPL7QUtJ3Ph1YVeWsHuqecLcvq0RzlMqxexK2XmF96WzMtIbYMvO', NULL, 'iputkinasih@gmail.com', 10, 1529553845, 1529560658);
...
ALTER TABLE `backend_permission`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_permission_feature` (`feature`),
  ADD KEY `FK_permission_roles` (`roles`);
