...
<input type="hidden" id="url-category" value="<?php echo Url::to('/feature');?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ( CMS::check_permission(Permission::FULL_ACCESS) ):?>
                                    <a onclick="show_delete_popup(<?php echo $item->id;?>,'<?php echo $item->name;?>')" class="btn btn-primary btn-xs btn-round" title="Delete Feature" rel="tooltip">
            ...
            <div class="col-md-pull-12">
                <div class="box box-danger box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Delete Feature</h3>
