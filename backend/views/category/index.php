...
<input type="hidden" id="url-category" value="<?php echo Url::to('/category');?>">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <table class="table table-bordered table-striped table-data-features-custom">
                <thead>
                    <th class="w5">No</th>
                    <th class="w15">Picture</th>
                    <th class="w15">Name</th>
                    <th class="w15">Slug</th>
                ...
                <tbody>
                    ...
                    <?php foreach($dataProvider as $item):?>
                        <tr>
                            ...
                            <td class="w15"><?php echo $item->name;?></td>
                            <td class="w15"><?php echo $item->slug;?></td>
                            <td class="w30"><?php echo $item->description;?></td>
                            <td class="w10">
                                <?php
                                    if ($item->status == 1) :
                                        echo "Active";
